<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_sublist.aspx.cs" Inherits="course" %>
      ...
      <div  class="nav-container">
        ...
        <nav  class="nav-main">
          <ul  data-breakpoint="992"  class="flexnav with-js opacity lg-screen">
            ...
            <li  class="active item-with-ul"><a  href="course_.html">我要选课</a>
        ...
        <div class="C-sub">
            <div class="C-sub-container">
                <div class="C-sub-left col-md-9">
                    ...
                    您现在所在的位置：<a href="Default.html">华樱外语</a>>><a href="news_sublist.aspx">华樱外语资讯</a>>><asp:Literal ID="ltlnewsnavi" runat="server" Visible="true"></asp:Literal>
                    </div>
                    <div class="Nl-head">
                    <asp:Label runat="server">华樱外语资讯</asp:Label>
                        </div>
                    <div class="NL-list">
                        <asp:ListView ID="ListView1" runat="server" DataKeyNames="id" DataSourceID="SqlDataSource1" EnableModelValidation="True">
                            ...
                            <ItemTemplate>
                                <tr style="width:800px;padding:10px 0;">
                                     <td style="width:80px;">
                                         <asp:HyperLink runat="server" Text='<%# whichType(Eval("sub_type").ToString()) %>' NavigateUrl='<%# Eval("sub_type","news_sublist_{0}_1.html") %>' />
                                    </td>
                                    <td style="width:620px;">
                                        <asp:HyperLink ID="titleLabel" runat="server" Text='<%# StringSub(Eval("title").ToString(),60) %>' NavigateUrl='<%# Eval("id","news_detail_{0}.html") %>' />
                                    </td>
                                    <td>
                    ...
                    <div id="Div1" class="NL-pager" runat="server" style="">
                                            <div>
                                           <asp:Literal ID="ltlpager" runat="server" Visible="true"></asp:Literal>

                                                </div>
                                        </div>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MeconnectionString %>" SelectCommand="SELECT * FROM [news] ORDER BY [date]"></asp:SqlDataSource>
                </div>
                <div class="C-sub-right col-md-3">
                    <asp:Image ID="Image2" runat="server" Width="264" ImageUrl="~/images/upload_files/banner/right.png" />
