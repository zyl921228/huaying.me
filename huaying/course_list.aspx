<%@ Page Language="C#" AutoEventWireup="true" CodeFile="course_list.aspx.cs" Inherits="course" %>
        ...
        <div class="C-sub">
            <div class="C-sub-container">
                <div class="C-sub-left col-md-9">
                    ...
                    <div class="C-sub-list">
                        <asp:Literal ID="ltlcourselist" runat="server" Visible="true"></asp:Literal> 
                    </div>
                </div>
                <div class="C-sub-right col-md-3">
                    <asp:Image ID="Image_right" runat="server" Width="264" ImageUrl="~/images/upload_files/banner/right.png" />
