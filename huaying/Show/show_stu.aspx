<%@ Page Language="C#" AutoEventWireup="true" CodeFile="show_stu.aspx.cs" Inherits="Show_show_stu" %>
...
<body>
    ...
    <div class="show-up-left">
        <asp:Image ID="laststudentPic" runat="server" Visible="false" Width="220" Height="220"
